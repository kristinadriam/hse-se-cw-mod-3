...
//
// ChatService provides a single bidirectional stream for P2P messaging.
...
func _ChatService_StreamChat_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ChatServiceServer).StreamChat(&chatServiceStreamChatServer{ServerStream: stream})
}

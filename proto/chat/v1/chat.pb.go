...
const file_proto_chat_v1_chat_proto_rawDesc = "" +
	"\n" +
	"\x18proto/chat/v1/chat.proto\x12\achat.v1\"h\n" +
	"\vChatMessage\x12\x1f\n" +
	"\vsender_name\x18\x01 \x01(\tR\n" +
	"senderName\x12$\n" +
	"\x0esent_unix_nano\x18\x02 \x01(\x03R\fsentUnixNano\x12\x12\n" +
	"\x04body\x18\x03 \x01(\tR\x04body2K\n" +
	"\vChatService\x12<\n" +
	"\n" +
	"StreamChat\x12\x14.chat.v1.ChatMessage\x1a\x14.chat.v1.ChatMessage(\x010\x01B&Z$hse-se-cw-mod-3/proto/chat/v1;chatv1b\x06proto3"
